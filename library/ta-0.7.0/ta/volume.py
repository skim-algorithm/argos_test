...
def force_index(close, volume, window=13, fillna=False):
    ...
    Returns:
        pandas.Series: New feature generated.
    """
    return ForceIndexIndicator(close=close, volume=volume, window=window, fillna=fillna).force_index()
...
def ease_of_movement(high, low, volume, window=14, fillna=False):
    ...
    Returns:
        pandas.Series: New feature generated.
    """
    return EaseOfMovementIndicator(high=high, low=low, volume=volume, window=window, fillna=fillna).ease_of_movement()
...
def money_flow_index(high, low, close, volume, window=14, fillna=False):
    ...
    """
    indicator = MFIIndicator(high=high, low=low, close=close, volume=volume, window=window, fillna=fillna)
...
def volume_weighted_average_price(
    ...
    indicator = VolumeWeightedAveragePrice(high=high, low=low, close=close, volume=volume, window=window, fillna=fillna)
